...
def make_squad_hf_dataset(tokenizer, batch_size, fp8=False, packed_sequence_size):
...
def main():
    ...
    llm.api.finetune(
        model=model,
        data=make_squad_hf_dataset(model.tokenizer, args.batch_size, args.fp8, args.packed_sequence_size),
        trainer=nl.Trainer(
